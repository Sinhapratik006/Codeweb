const questions = [
  ...
  {
    question: "C language was developed at which laboratory?",
    options: {
      A: "Bell Labs",
      B: "IBM Labs",
  ...
  {
    question: "C language is a ____ level language.",
  ...
  {
    question: "What is the correct format specifier for an integer in printf?",
